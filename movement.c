...
/*   Updated: 2025/02/09 10:36:57 by admin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static int is_collision(t_World_Controller *world, double new_x, double new_y)
{
    ...
    if (tile_x < 0 || tile_y < 0 ||
        tile_x >= world->mini_map->size_int.x || tile_y >= world->mini_map->size_int.y)
...
void set_movement(t_World_Controller *world, t_DoublePair delta)
{
    ...
    double new_x = world->player->pos.x + delta.x;
    double new_y = world->player->pos.y + delta.y;
