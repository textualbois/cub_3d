...
/*   Updated: 2025/02/19 17:24:14 by vmamoten         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void uncentre_character_img_v(t_World_Controller *world, t_mini_map *map, t_DoublePair pos)
{
	...
	if (pos.y < map->visible_size.y / 2)
	{
		...
		world->mini_character->instances[0].y = world->map_img->instances[0].y + pixel_offset - world->mini_character->height / 2; // need to factor in world->miniCharacter->height / 2
	...
	else if (pos.y > map->size.y - map->visible_size.y / 2)
	{
		...
		world->mini_character->instances[0].y = world->map_img->instances[0].y + pixel_offset - world->mini_character->height / 2;
...
void	centre_character_img_v(t_World_Controller *world)
{
	...
	// printf("pos.y: %f\n", world->player->pos.y);
	world->mini_character->instances[0].y = world->map_img->instances[0].y + world->map_img->height / 2 - world->mini_character->height / 2;
...
void uncentre_character_img_h(t_World_Controller *world, t_mini_map *map, t_DoublePair pos)
{
	...
	if (pos.x < map->visible_size.x / 2)
	{
		...
		world->mini_character->instances[0].x = world->map_img->instances[0].x + pixel_offset - world->mini_character->width / 2; // need to factor in world->miniCharacter->width / 2
	...
	else if (pos.x > map->size.x - map->visible_size.x / 2)
	{
		...
		world->mini_character->instances[0].x = world->map_img->instances[0].x + pixel_offset - world->mini_character->width / 2;
...
void centre_character_img_h(t_World_Controller *world)
{
	...
	// printf("pos.x: %f\n", world->player->pos.x);
	world->mini_character->instances[0].x = world->map_img->instances[0].x + world->map_img->width / 2 - world->mini_character->width / 2;
